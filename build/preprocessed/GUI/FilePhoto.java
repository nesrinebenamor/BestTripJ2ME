 ...
 *
 */
public class FilePhoto implements CommandListener {
    ...
    public FilePhoto(Display disp,String id_exp,String description) {
        this.disp=disp;
        this.id_exp=id_exp;
    ...
    public void inserer(String image) {
        try {
            hc = (HttpConnection) Connector.open("http://localhost/experience/ajoutPhoto.php"
                    +"?image="+image
