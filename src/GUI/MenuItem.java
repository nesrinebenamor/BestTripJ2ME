 ...
 * @author esprit
 */
public class MenuItem extends Form implements Runnable,ItemCommandListener{
    ...
    espaceAdmin=new Command("Espace Admin",Command.ITEM,2);
      ...
      try {
            image = Image.createImage("/add.png");
            ImageItem img1=new ImageItem("Ajouter", image, ImageItem.LAYOUT_RIGHT,null);
           // append(img1);
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    
      ImageItem imageItem=new ImageItem("Ajouter", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(add);
      append(imageItem);
       ImageItem imageItem1=new ImageItem("View", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(view);
      append(imageItem);
       ImageItem imageItem2=new ImageItem("delete", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(delete);
      append(imageItem);
       ImageItem imageItem3=new ImageItem("Mail", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(sendMail);
      append(imageItem);
       ImageItem imageItem4=new ImageItem("Ajouter", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(add);
      append(imageItem);
       ImageItem imageItem5=new ImageItem("Ajouter", image, ImageItem.LAYOUT_RIGHT,null);
      imageItem.setItemCommandListener(this);
      imageItem.setDefaultCommand(add);
      append(imageItem);
 ...
 if (c == add && item == imageItem) {
     System.out.println("test image item1");
       utils.StaticMidlet.disp.setCurrent(new AjoutUtilisateur());
       System.out.println("test image item2");
    }
    }
